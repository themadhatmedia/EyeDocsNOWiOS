//
//  MyProfileMyPortfolioTableViewCell.swift
//  Opportunities
//
...
class MyProfileMyPortfolioTableViewCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let url = URL(string: dataArray[indexPath.row]){
