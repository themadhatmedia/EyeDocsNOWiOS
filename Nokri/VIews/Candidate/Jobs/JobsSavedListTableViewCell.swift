//
//  JobsSavedListTableViewCell.swift
//  Opportunities
//
...
class JobsSavedListTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
       ...
       // lblPartOrFullTime.backgroundColor = UIColor(hex: appColorNew!)
        ...
        //nokri_shadow()
        nokri_roundedImage()
       // lblPartOrFullTime.layer.cornerRadius = 5
...
//    func dropDownSetup(){
//
//        dropDown.dataSource = ["Featured", "Private", "Free" ,"Spotlight"]
...
//        DropDown.appearance().selectionBackgroundColor = UIColor(hex:"1DA3F4")
