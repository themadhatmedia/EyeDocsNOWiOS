...
import UIKit
import Alamofire
protocol LocThirdLevelDelegate: class {
    func sendLocThirdLevelId(locId: Int)
}

class JobPostCityViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,LocFourthLevelDelegate {
        ...
        @IBOutlet weak var tableView: UITableView!
         ...
         var jobSubCatArrat = NSMutableArray()
           ...
           var key:Int = 0
    var delegate: LocThirdLevelDelegate?
           var fourthLevelLocId = 0
    ...
    func sendLocFourthLevelId(locId: Int) {
        print(locId)
        self.fourthLevelLocId = locId
        delegate?.sendLocThirdLevelId(locId: self.fourthLevelLocId)
         ...
         @objc func btnNext(sender: UIButton!){
              ...
              UserDefaults.standard.set(sender.tag, forKey:"co3Key")
                 ...
                 if sender.currentTitle == "false"{
                    ...
                    delegate?.sendLocThirdLevelId(locId: sender.tag)
                     self.perform(#selector(self.nokri_showNavController1), with: nil, afterDelay: 0)
