//
//  CompanyPortfolioImgTableViewCell.swift
//  Nokri
//
...
class CompanyPortfolioImgTableViewCell: UITableViewCell,UICollectionViewDelegate,UICollectionViewDataSource {

    @IBOutlet weak var collectionView: UICollectionView!
    var dataArray = [String]()
    var delegate:imagesDelegate?
    var notPortfo:String?
    var datImgArr = [DashboardImages]()
