...
class PackagesViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,GADBannerViewDelegate,SwiftyAdDelegate/*PayPalPaymentDelegate*/ {
...
//    var payPalConfig = PayPalConfiguration() // default
    ...
    var bumpUpAdNo = ""
    var bumpUpAdText = ""
    var bumpUpArr = [BuyPackagePremiumJob]()
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if obj.isFree == "1"{
            ...
            cell.lblNoOfCand.text = ""
            cell.lblCandSearch.text = ""
            ...
            cell.lblNoOfCand.text = obj.feature_days_value
            cell.lblCandSearch.text = obj.feature_days_text
        ...
        //bumpUpArr = obj.bumpJobs + obj.premiumJobs
        
        cell.premiumArray = premiumArr
...
//                    self.bumpUpArr = obj.bumpJobs
//                }
                for obj in successResponse.data.products{
                    self.premiumArr = obj.premiumJobs
                }
                //self.bumpUpArr = self.premiumArr
