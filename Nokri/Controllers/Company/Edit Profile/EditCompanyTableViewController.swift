...
class EditCompanyTableViewController: UITableViewController,GMSMapViewDelegate,GMSAutocompleteViewControllerDelegate,CLLocationManagerDelegate,UITextFieldDelegate  {
    ...
    @IBOutlet weak var heightConstTextLoc: NSLayoutConstraint!
    @IBOutlet weak var viewSep: UIView!
    @IBOutlet weak var heightConstMapView: NSLayoutConstraint!
    @IBOutlet weak var viewLatLong: UIView!
    @IBOutlet weak var heightConstLocationLlbl: NSLayoutConstraint!
    
    @IBOutlet weak var topConstViewContry: NSLayoutConstraint!
       ...
       override func viewDidLoad() {
        ...
        if mapHide == true{
            heightConstLocationLlbl.constant = 0
            lblLocation.isHidden = true
            heightConstTextLoc.constant = 0
            txtLocation.isHidden = true
            mapView.isHidden = true
            heightConstMapView.constant = 0
            viewLatLong.isHidden = true
            tableView.isScrollEnabled = false
            topConstViewContry.constant -= 100
