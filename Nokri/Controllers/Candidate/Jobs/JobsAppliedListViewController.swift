...
class JobsAppliedListViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,GADBannerViewDelegate,SwiftyAdDelegate {
        ...
        if listStyle == "style2"{
            ...
            for itemDict in selectedActiveJob! {
                ...
                if let field_type_name = innerDict["field_type_name"] as? String{
                    ...
                    if field_type_name == "job_apply_status" {
                        if let value = innerDict["value"] as? String {
                        print(value)
                            cell.lblStatus.text = value
                        }
                    }
                }
