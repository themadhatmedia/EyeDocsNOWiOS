...
internal struct DPDConstant {
	...
	internal struct UI {
        ...
        //static let TextAlign = NSTextAlignment.right.rawValue
    ...
    internal struct Animation {
        ...
        static let EntranceOptions: UIView.AnimationOptions.ArrayLiteralElement = [.allowUserInteraction, .curveEaseOut]
        static let ExitOptions: UIView.AnimationOptions.ArrayLiteralElement = [.allowUserInteraction, .curveEaseIn]
